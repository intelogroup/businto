...
- [x] **Operator quote submission UI** — form to submit price + ETA on a received request; currently operators get email only
...
- [x] **Operator profile completion flow** — onboarding checklist: add specialties, service radius, vehicle info, documents
